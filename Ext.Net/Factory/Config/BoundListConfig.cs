...
namespace Ext.Net
{
    ...
    public partial class BoundList
    {
        ...
        /// 
        /// </summary>
        public BoundList(Config config)
        {
            this.Apply(config);
        }


		/*  Implicit BoundList.Config Conversion to BoundList
			-----------------------------------------------------------------------------------------------*/

        /// <summary>
        /// 
        /// </summary>
        public static implicit operator BoundList(BoundList.Config config)
        {
            return new BoundList(config);
        }
        ...
        { 
			/*  Implicit BoundList.Config Conversion to BoundList.Builder
				-----------------------------------------------------------------------------------------------*/
        
            /// <summary>
			/// 
			/// </summary>
			public static implicit operator BoundList.Builder(BoundList.Config config)
			{
				return new BoundList.Builder(config);
			}

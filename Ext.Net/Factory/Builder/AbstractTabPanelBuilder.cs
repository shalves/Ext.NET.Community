...
namespace Ext.Net
{
    ...
    public abstract partial class AbstractTabPanel
    {
            ...
            where TBuilder : Builder<TAbstractTabPanel, TBuilder>
        {
            ...
            public virtual TBuilder TabBar(Action<ItemsCollection<AbstractComponent>> action)
            {
                action(this.ToComponent().TabBar);
                return this as TBuilder;
            }
			...
			/// 
			/// </summary>
            public virtual TBuilder SetLastTabAsActive()
            {
                this.ToComponent().SetLastTabAsActive();
                return this as TBuilder;
            }
			...
			/// 
			/// </summary>
            public virtual TBuilder SetPreviousTabAsActive()
            {
                this.ToComponent().SetPreviousTabAsActive();
                return this as TBuilder;
            }
			...
			/// 
			/// </summary>
            public virtual TBuilder SetNextTabAsActive()
            {
                this.ToComponent().SetNextTabAsActive();
                return this as TBuilder;
            }

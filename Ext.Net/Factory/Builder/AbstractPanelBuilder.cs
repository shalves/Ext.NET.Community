...
namespace Ext.Net
{
    ...
    public abstract partial class AbstractPanel
    {
            ...
            where TBuilder : Builder<TAbstractPanel, TBuilder>
        {
            ...
            public virtual TBuilder TabConfig(Action<Button> action)
            {
                action(this.ToComponent().TabConfig);
			...
			/// A component or series of components to be added as docked items to this panel. The docked items can be docked to either the top, right, left or bottom of a panel.
 			...
 			/// <param name="action">The action delegate</param>
 			/// <returns>An instance of TBuilder</returns>
            public virtual TBuilder DockedItems(Action<ItemsCollection<AbstractComponent>> action)
            {
                action(this.ToComponent().DockedItems);
                return this as TBuilder;
            }
			...
			/// </summary>
            public virtual TBuilder HeaderConfig(PanelHeader headerConfig)
            {
                this.ToComponent().HeaderConfig = headerConfig;
                return this as TBuilder;
            }
			...
			/// </summary>
            public virtual TBuilder ManageHeight(bool manageHeight)
            {
                this.ToComponent().ManageHeight = manageHeight;
                return this as TBuilder;
            }
			...
			/// A Component (or config object for a Component) to show in place of this Panel when this Panel is collapsed by a border layout. Defaults to a generated Header containing a Tool to re-expand the Panel.
 			...
 			/// <param name="action">The action delegate</param>
 			/// <returns>An instance of TBuilder</returns>
            public virtual TBuilder PlaceHolder(Action<ItemsCollection<AbstractComponent>> action)
            {
                action(this.ToComponent().PlaceHolder);
                return this as TBuilder;
            }
			...
			/// A KeyMap config object (in the format expected by Ext.KeyMap.addBinding used to assign custom key handling to this panel (defaults to null).
 			...
 			/// <param name="action">The action delegate</param>
 			/// <returns>An instance of TBuilder</returns>
            public virtual TBuilder KeyMap(Action<KeyBindingCollection> action)
            {
                action(this.ToComponent().KeyMap);
                return this as TBuilder;
            }

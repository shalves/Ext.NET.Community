...
namespace Ext.Net
{
    ...
    public partial class CommandMenu
    {
        ...
        /// 
        /// </summary>
        public partial class Builder : BaseItem.Builder<CommandMenu, CommandMenu.Builder>
        {
            /*  Ctor
                -----------------------------------------------------------------------------------------------*/
			...
			/// 
 			...
 			/// <returns>An instance of CommandMenu.Builder</returns>
            public virtual CommandMenu.Builder Items(Action<MenuCommandCollection> action)
            {

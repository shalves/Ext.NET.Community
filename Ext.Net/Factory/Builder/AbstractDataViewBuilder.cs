...
namespace Ext.Net
{
    ...
    public abstract partial class AbstractDataView
    {
        ...
        /// 
        /// </summary>
        new public abstract partial class Builder<TAbstractDataView, TBuilder> : ComponentBase.Builder<TAbstractDataView, TBuilder>
            ...
            where TBuilder : Builder<TAbstractDataView, TBuilder>
        {
			...
			/// </summary>
            public virtual TBuilder PreserveScrollOnRefresh(bool preserveScrollOnRefresh)
            {
                this.ToComponent().PreserveScrollOnRefresh = preserveScrollOnRefresh;
                return this as TBuilder;
            }
			...
			/// 
 			...
 			/// <param name="action">The action delegate</param>
 			/// <returns>An instance of TBuilder</returns>
            public virtual TBuilder PrepareData(Action<JFunction> action)
            {
                action(this.ToComponent().PrepareData);
                return this as TBuilder;
            }

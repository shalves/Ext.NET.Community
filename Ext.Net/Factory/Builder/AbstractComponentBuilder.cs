...
namespace Ext.Net
{
    ...
    public abstract partial class AbstractComponent
    {
            ...
            where TBuilder : Builder<TAbstractComponent, TBuilder>
        {
			...
			/// 
			/// </summary>
            public virtual TBuilder TagHiddenName(string tagHiddenName)
            {
                this.ToComponent().TagHiddenName = tagHiddenName;
			...
			/// 
			/// </summary>
            public virtual TBuilder TagString(string tagString)
            {
                this.ToComponent().TagString = tagString;
                return this as TBuilder;
            }
			...
			/// 
			/// </summary>
            public virtual TBuilder UpdateLayout()
            {
                this.ToComponent().UpdateLayout();
                return this as TBuilder;
            }

...
namespace Ext.Net
{
    ...
    public abstract partial class DropDownFieldBase
    {
        ...
        /// 
        /// </summary>
        new public abstract partial class Builder<TDropDownFieldBase, TBuilder> : PickerField.Builder<TDropDownFieldBase, TBuilder>
            ...
            where TBuilder : Builder<TDropDownFieldBase, TBuilder>
        {
            ...
            public virtual TBuilder Component(Action<ItemsCollection<AbstractContainer>> action)
            {

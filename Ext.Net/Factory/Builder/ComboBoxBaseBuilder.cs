...
namespace Ext.Net
{
    ...
    public abstract partial class ComboBoxBase
    {
        ...
        /// 
        /// </summary>
        new public abstract partial class Builder<TComboBoxBase, TBuilder> : PickerField.Builder<TComboBoxBase, TBuilder>
            ...
            where TBuilder : Builder<TComboBoxBase, TBuilder>
        {
			...
			/// 
			/// </summary>
            public virtual TBuilder ItemsFromEnum(Type itemsFromEnum)
            {
                this.ToComponent().ItemsFromEnum = itemsFromEnum;
                return this as TBuilder;
            }

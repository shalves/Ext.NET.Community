...
namespace Ext.Net
{
    ...
    public abstract partial class AbstractWindow
    {
        ...
        /// 
        /// </summary>
        new public abstract partial class Builder<TAbstractWindow, TBuilder> : AbstractPanel.Builder<TAbstractWindow, TBuilder>
            ...
            where TBuilder : Builder<TAbstractWindow, TBuilder>
        {
			...
			/// </summary>
            public virtual TBuilder Ghost(bool ghost)
            {
                this.ToComponent().Ghost = ghost;
                return this as TBuilder;
            }

...
namespace Ext.Net
{
    ...
    public abstract partial class AbstractContainer
    {
            ...
            where TBuilder : Builder<TAbstractContainer, TBuilder>
        {
			...
			/// </summary>
            public virtual TBuilder AnchorHeight(int anchorHeight)
            {
                this.ToComponent().AnchorHeight = anchorHeight;
			...
			/// </summary>
            public virtual TBuilder AnchorWidth(int anchorWidth)
            {
                this.ToComponent().AnchorWidth = anchorWidth;
                return this as TBuilder;
            }
			...
			/// </summary>
            public virtual TBuilder DetachOnRemove(bool detachOnRemove)
            {
                this.ToComponent().DetachOnRemove = detachOnRemove;
                return this as TBuilder;
            }

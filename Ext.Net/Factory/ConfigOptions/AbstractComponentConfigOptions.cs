    ...
    public abstract partial class AbstractComponent
    {
        ...
        public override ConfigOptionsCollection ConfigOptions
        {
            get
            {
                ...
                list.Add("tagHiddenName", new ConfigOption("tagHiddenName", null, null, this.TagHiddenName ));
                ...
                list.Add("loader", new ConfigOption("loader", new SerializationOptions("loader", typeof(LazyControlJsonConverter)), null, this.Loader ));
                ...
                list.Add("stateful", new ConfigOption("stateful", null, false, this.Stateful ));
                ...
                list.Add("weight", new ConfigOption("weight", null, 0, this.Weight ));

    ...
    public partial class GroupingSummary
    {
        ...
        public override ConfigOptionsCollection ConfigOptions
        {
            get
            {
                ...
                list.Add("showSummaryRow", new ConfigOption("showSummaryRow", null, true, this.ShowSummaryRow ));
                list.Add("remoteRoot", new ConfigOption("remoteRoot", null, "", this.RemoteRoot ));

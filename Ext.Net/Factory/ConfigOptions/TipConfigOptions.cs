    ...
    public abstract partial class Tip
    {
        ...
        public override ConfigOptionsCollection ConfigOptions
        {
            get
            {
                ...
                list.Add("constrainPosition", new ConfigOption("constrainPosition", null, true, this.ConstrainPosition ));
                list.Add("defaultAlign", new ConfigOption("defaultAlign", null, "", this.DefaultAlign ));
                list.Add("maxWidth", new ConfigOption("maxWidth", null, 500, this.MaxWidth ));
                list.Add("minWidth", new ConfigOption("minWidth", null, 40, this.MinWidth ));

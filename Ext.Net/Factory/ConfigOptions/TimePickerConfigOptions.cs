    ...
    public partial class TimePicker
    {
        ...
        public override ConfigOptionsCollection ConfigOptions
        {
            get
            {
                ...
                list.Add("maxTimeProxy", new ConfigOption("maxTimeProxy", new SerializationOptions("maxValue", JsonMode.Raw), "", this.MaxTimeProxy ));
                list.Add("minTimeProxy", new ConfigOption("minTimeProxy", new SerializationOptions("minValue", JsonMode.Raw), "", this.MinTimeProxy ));

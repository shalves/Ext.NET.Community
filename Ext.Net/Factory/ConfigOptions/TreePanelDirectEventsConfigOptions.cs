    ...
    public partial class TreePanelDirectEvents
    {
        ...
        public override ConfigOptionsCollection ConfigOptions
        {
            get
            {
                ...
                list.Add("beforeDblClick", new ConfigOption("beforeDblClick", new SerializationOptions("beforedblclick", typeof(DirectEventJsonConverter)), null, this.BeforeDblClick ));

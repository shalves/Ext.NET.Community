    ...
    public partial class PanelListeners
    {
        ...
        public override ConfigOptionsCollection ConfigOptions
        {
            get
            {
                ...
                list.Add("float", new ConfigOption("float", new SerializationOptions("float", typeof(ListenerJsonConverter)), null, this.Float ));
                list.Add("unfloat", new ConfigOption("unfloat", new SerializationOptions("unfloat", typeof(ListenerJsonConverter)), null, this.Unfloat ));

...
namespace Ext.Net
{
    ...
    /// 
    /// </summary>
    public partial class BoxReordererListeners
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        public override ConfigOptionsCollection ConfigOptions
        {
            get
            {
                ...
                list.Add("changeIndex", new ConfigOption("changeIndex", new SerializationOptions("ChangeIndex", typeof(ListenerJsonConverter)), null, this.ChangeIndex ));

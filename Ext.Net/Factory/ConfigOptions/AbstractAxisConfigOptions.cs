    ...
    public abstract partial class AbstractAxis
    {
        ...
        public override ConfigOptionsCollection ConfigOptions
        {
            get
            {
                ...
                list.Add("axisID", new ConfigOption("axisID", null, "", this.AxisID ));
                list.Add("labelTitle", new ConfigOption("labelTitle", new SerializationOptions(JsonMode.Object), null, this.LabelTitle ));

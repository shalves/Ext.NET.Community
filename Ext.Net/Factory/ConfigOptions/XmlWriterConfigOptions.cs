    ...
    public partial class XmlWriter
    {
        ...
        public override ConfigOptionsCollection ConfigOptions
        {
            get
            {
                ...
                list.Add("defaultDocumentRoot", new ConfigOption("defaultDocumentRoot", null, "", this.DefaultDocumentRoot ));
                list.Add("documentRoot", new ConfigOption("documentRoot", null, "", this.DocumentRoot ));

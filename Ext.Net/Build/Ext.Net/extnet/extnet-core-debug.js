            ...
            Ext.each(name, function (icon) {
                ...
                if (!this.hasCssClass(id)) {
                    if (icon.url) {
                        ...
                        var template = ".{0}{background-image:url(\"/{1}icons/{2}-png/ext.axd\") !important;background-repeat:no-repeat;}",
                            appName = Ext.isEmpty(this.appName, false) ? "" : (this.appName + "/");
    ...
    initIndicator : function () {
        ...
        var f = function () {            
            if (!Ext.isEmpty(this.indicatorText, false) || 
                ...
                this.indicatorEl.on("click", this.onIndicatorIconClick, this);

                if (this.initialConfig.listeners && this.initialConfig.listeners.indicatoriconclick ||
                    this.initialConfig.directEvents && this.initialConfig.directEvents.indicatoriconclick) {

                    this.indicatorEl.applyStyles("cursor: pointer;");
                }
            }
        };
...
Ext.form.Label.override({
    ...
    append : function (text, appendLine) {
        ...
        this.setText(oldValue += text + (appendLine === true ? "<br/>" : ""), false);
    },
...
Ext.extend(Ext.net.ComboMenuItem, Ext.menu.BaseItem, {
    ...
    beforeDestroy : function () {
        this.component.destroy();
        Ext.net.ComboMenuItem.superclass.beforeDestroy.call(this);
    }
});
...
Ext.extend(Ext.net.DateFieldMenuItem, Ext.menu.BaseItem, {
    ...
    beforeDestroy : function () {
        this.component.destroy();
        Ext.net.DateFieldMenuItem.superclass.beforeDestroy.call(this);
    }
});
...
Ext.extend(Ext.net.ComponentMenuItem, Ext.menu.BaseItem, {
    ...
    beforeDestroy : function () {
        this.component.destroy();
        Ext.net.ComponentMenuItem.superclass.beforeDestroy.call(this);
    }
});
...
(function () {
    ...
    if (Ext.isIE7) {
        ...
        buf.push(".ext-ie7 .x-small-editor.x-grid-editor .x-form-field{margin-top:0px!important;}");
    }
    ...
    buf.push(".x-toolbar div.xtb-text.icon-lock{background-position: 3px 1px;}");
    ...
    if (Ext.isIE9) {
        ...
        buf.push(".ext-strict .ext-ie9 .x-date-menu{height:auto !important;}");
    } 

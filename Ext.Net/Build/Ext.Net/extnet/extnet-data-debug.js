...
Ext.ux.data.PagingStore = Ext.extend(Ext.net.Store, {
    ...
    loadData : function (o, append) {
        ...
        this.isPaging(Ext.apply({}, this.lastOptions && !Ext.isEmptyObj(this.lastOptions) ? this.lastOptions.params : options.params, this.baseParams));
    ...
    findPage : function (record) {
        if ((typeof this.limit === "number")) {
            return Math.ceil(((this.allData || this.data).indexOf(record) + 1) / this.limit);
        }

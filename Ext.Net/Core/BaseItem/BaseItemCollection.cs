...
namespace Ext.Net
{
	...
	/// </summary>
	[Description("")]
    public abstract partial class BaseItemCollection<T> : IList<T>, IStateManager, IXObject, IList where T : BaseItem
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        public virtual string Serialize()
        {
            ...
            foreach (T o in this)
            {
                ...
                {
                    sb.Append(JSON.Serialize(o));
                }
                else
                {
                    sb.Append(new ClientConfig().SerializeInternal(o, this.Owner));
                }

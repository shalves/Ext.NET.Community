...
namespace Ext.Net
{
    ...
    public partial class AbstractComponentListeners : ComponentListeners
    {
        ...
        private ComponentListener boxready;
        ...
        [TypeConverter(typeof(ExpandableObjectConverter))]
        [ConfigOption("boxready", typeof(ListenerJsonConverter))]
        [PersistenceMode(PersistenceMode.InnerProperty)]
        [NotifyParentProperty(true)]
        [Description("Fires one time - after the component has been layed out for the first time at its initial size.")]
        public virtual ComponentListener BoxReady
        {
            get
            {
                return this.boxready ?? (this.boxready = new ComponentListener());
            }
        }
    }
}
...
namespace Ext.Net
{
    ...
    public partial class DataViewListeners : AbstractComponentListeners
    {
        ...
        private ComponentListener highlightitem;
        ...
        [ListenerArgument(1, "node", typeof(object))]
        [TypeConverter(typeof(ExpandableObjectConverter))]
        [ConfigOption("highlightitem", typeof(ListenerJsonConverter))]
        [PersistenceMode(PersistenceMode.InnerProperty)]
        [NotifyParentProperty(true)]
        [Description("Fires when a node is highlighted using keyboard navigation, or mouseover.")]
        public virtual ComponentListener HighlightItem
        {
            get
            {
                return this.highlightitem ?? (this.highlightitem = new ComponentListener());
            }
        }
        ...
        private ComponentListener unhighlightitem;
        ...
        [ListenerArgument(1, "node", typeof(object))]
        [TypeConverter(typeof(ExpandableObjectConverter))]
        [ConfigOption("unhighlightitem", typeof(ListenerJsonConverter))]
        [PersistenceMode(PersistenceMode.InnerProperty)]
        [NotifyParentProperty(true)]
        [Description("Fires before the item updating")]
        public virtual ComponentListener UnhighlightItem
        {
            get
            {
                return this.unhighlightitem ?? (this.unhighlightitem = new ComponentListener());
            }
        }

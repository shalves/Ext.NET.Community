...
namespace Ext.Net
{
	...
	/// </summary>
	[Description("")]
    public partial class InlineEditorDirectEvents : AbstractComponentDirectEvents
    {
        public InlineEditorDirectEvents() { }

        public InlineEditorDirectEvents(Observable parent) { this.Parent = parent; }
        ...
        public virtual ComponentDirectEvent BeforeStartEdit
        {
            get
            {
                return this.beforestartedit ?? (this.beforestartedit = new ComponentDirectEvent(this));
            }
        }
        ...
        public virtual ComponentDirectEvent BeforeComplete
        {
            get
            {
                return this.beforecomplete ?? (this.beforecomplete = new ComponentDirectEvent(this));
            }
        }
        ...
        public virtual ComponentDirectEvent Complete
        {
            get
            {
                return this.complete ?? (this.complete = new ComponentDirectEvent(this));
            }
        }
        ...
        public virtual ComponentDirectEvent StartEdit
        {
            get
            {
                return this.startedit ?? (this.startedit = new ComponentDirectEvent(this));
            }
        }
    }
}
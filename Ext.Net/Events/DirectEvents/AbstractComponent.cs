...
namespace Ext.Net
{
    ...
    public partial class AbstractComponentDirectEvents : ComponentDirectEvents
    {
        ...
        [PersistenceMode(PersistenceMode.InnerProperty)]
        [NotifyParentProperty(true)]
        [Description("Fires when this Component loses focus.")]
        ...
        [PersistenceMode(PersistenceMode.InnerProperty)]
        [NotifyParentProperty(true)]
        [Description("Fires when this Component receives focus.")]
        ...
        private ComponentDirectEvent boxready;
        ...
        [TypeConverter(typeof(ExpandableObjectConverter))]
        [ConfigOption("boxready", typeof(DirectEventJsonConverter))]
        [PersistenceMode(PersistenceMode.InnerProperty)]
        [NotifyParentProperty(true)]
        [Description("Fires one time - after the component has been layed out for the first time at its initial size.")]
        public virtual ComponentDirectEvent BoxReady
        {
            get
            {
                return this.boxready ?? (this.boxready = new ComponentDirectEvent(this));
            }
        }
    }
}
...
namespace Ext.Net
{
    ...
    public partial class DataViewDirectEvents : AbstractComponentDirectEvents
    {
        ...
        private ComponentDirectEvent highlightitem;
        ...
        [ListenerArgument(1, "node", typeof(object))]
        [TypeConverter(typeof(ExpandableObjectConverter))]
        [ConfigOption("highlightitem", typeof(DirectEventJsonConverter))]
        [PersistenceMode(PersistenceMode.InnerProperty)]
        [NotifyParentProperty(true)]
        [Description("Fires when a node is highlighted using keyboard navigation, or mouseover.")]
        public virtual ComponentDirectEvent HighlightItem
        {
            get
            {
                return this.highlightitem ?? (this.highlightitem = new ComponentDirectEvent(this));
            }
        }
        ...
        private ComponentDirectEvent unhighlightitem;
        ...
        [ListenerArgument(1, "node", typeof(object))]
        [TypeConverter(typeof(ExpandableObjectConverter))]
        [ConfigOption("unhighlightitem", typeof(DirectEventJsonConverter))]
        [PersistenceMode(PersistenceMode.InnerProperty)]
        [NotifyParentProperty(true)]
        [Description("Fires before the item updating")]
        public virtual ComponentDirectEvent UnhighlightItem
        {
            get
            {
                return this.unhighlightitem ?? (this.unhighlightitem = new ComponentDirectEvent(this));
            }
        }

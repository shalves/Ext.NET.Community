...
namespace Ext.Net
{
    ...
    public partial class Editor : AbstractContainer
    {
		/// <summary>
		/// 
		/// </summary>
        ...
        [DefaultValue(false)]
        [NotifyParentProperty(true)]
        [Description("true to use innerHTML of bound element, otherwise innerText will be used")]
        public virtual bool UseHtml
        {
            get
            {
                return this.State.Get<bool>("UseText", false);
            }
            set
            {
                this.State.Set("UseText", value);
            }
        }
        ...
        [DefaultValue(false)]
        [NotifyParentProperty(true)]
        [Description("True to encode value before start editing")]
        ...
        [DefaultValue(false)]
        [NotifyParentProperty(true)]
        [Description("True to decode value after editing")]
        public virtual bool HtmlDecode
        {
            get
            {
                return this.State.Get<bool>("HtmlDecode", false);
            }
            set
            {
                this.State.Set("HtmlDecode", value);
            }
        }

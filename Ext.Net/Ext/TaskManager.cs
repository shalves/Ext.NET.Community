...
namespace Ext.Net
{
    ...
    public partial class TaskManager : LazyObservable, IAjaxPostBackEventHandler
    {
		/// <summary>
		/// 
		/// </summary>
        ...
        public virtual int Interval
        {
            get
            {
                return this.State.Get<int>("Interval", 10);
            }
            set
            {
        ...
        public virtual int AutoRunDelay
        {
            get
            {
                return this.State.Get<int>("AutoRunDelay", 50);
            }
            set
            {
                this.State.Set("AutoRunDelay", value);
            }
        }

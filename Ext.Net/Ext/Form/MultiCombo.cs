...
namespace Ext.Net
{
    ...
    public partial class MultiCombo : ComboBoxBase, IPostBackEventHandler
    {
        ...
        [DefaultValue(false)]
        [Description("True to sort selected items by DisplayField. Defaults to false.")]
        public virtual bool SortByDisplayField
        {
            get
            {
                return this.State.Get<bool>("SortByDisplayField", false);
            }
            set
            {
                this.State.Set("SortByDisplayField", value);
            }
        }

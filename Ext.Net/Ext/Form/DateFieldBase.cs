...
namespace Ext.Net
{
    ...
    public abstract partial class DateFieldBase : PickerField, IDate
    {
        ...
        /// <summary>
        /// The error text to display when the date in the field is invalid (defaults to '{0} is not a valid date - it must be in the format {1}').
        /// </summary>
        [ConfigOption]
        [Category("8. DateField")]
        [DefaultValue("")]
        [Localizable(true)]
        [Description("The error text to display when the date in the field is invalid (defaults to '{0} is not a valid date - it must be in the format {1}').")]
        ...
        /// <summary>
        /// The error text to display when the date in the cell is after MaxValue (defaults to 'The date in this field must be equal to or before {0}').
        /// </summary>
        [Meta]
        [ConfigOption]
        [Category("8. DateField")]
        [DefaultValue("")]
        [Localizable(true)]
        [Description("The error text to display when the date in the cell is after MaxValue (defaults to 'TThe date in this field must be equal to or before {0}').")]
        ...
        [DefaultValue("")]
        [Localizable(true)]
        [Description("The error text to display when the date in the cell is before MinValue (defaults to 'The date in this field must be equal to or after {0}').")]
        ...
        [Category("8. DateField")]
        [DefaultValue(false)]
        [Description("True to enforce strict date parsing to prevent the default Javascript \"date rollover\". Defaults to the useStrict parameter set on Ext.Date See Ext.Date.parse.")]
        public virtual bool UseStrict
        {
            get
            {
                return this.State.Get<bool>("UseStrict", false);
            }
            set
            {
                this.State.Set("UseStrict", value);
            }
        }

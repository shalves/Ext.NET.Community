...
namespace Ext.Net
{
    ...
    public abstract partial class ButtonBase : ComponentBase, IIcon, IAutoPostBack, IPostBackEventHandler, IXPostBackDataHandler, IButtonControl, INoneContentable
    {
        ...
        protected virtual bool LoadPostData(string postDataKey, NameValueCollection postCollection)
        {
            ...
            string val = postCollection[this.PressedHiddenName.IsNotEmpty() ? this.PressedHiddenName : this.ConfigID.ConcatWith("_Pressed")];
        ...
        public virtual string PressedHiddenName
        {
            get
            {
                return this.State.Get<string>("PressedHiddenName", "");
            }
            set
            {
                this.State.Set("PressedHiddenName", value);
            }
        }
        ...
        /// <summary>
        /// The URL to open when the button is clicked. Specifying this config causes the Button to be rendered with an anchor (An <a> element) as its active element, referencing the specified URL.
        /// 
        ...
        [DefaultValue("_blank")]
        [DirectEventUpdate(GenerateMode = AutoGeneratingScript.Simple)]
        [Description("The target attribute to use for the underlying anchor. Only used if the href property is specified. Defaults to: \"_blank\"")]
        public virtual string HrefTarget
        {
            get
            {
                return this.State.Get<string>("HrefTarget", "_blank");
            }
            set
            {
        ...
        [Description("The path to an image to display in the button")]
        ...
        [Category("5. Button")]
        [DefaultValue(false)]
        [Description("True to start pressed (only if enableToggle = true). Defaults to: false")]
        ...
        /// </summary>
        /// <param name="state">Force a particular state</param>
        /// <param name="suppressEvent">True to stop events being fired when calling this method.</param>
        [Meta]
        public virtual void Toggle(bool state, bool suppressEvent)
        {
            this.Call("toggle", state, suppressEvent);
        }

    ...
    {        
        ...
        public virtual XTemplate RenderTpl
        {
            ...
            set
            {
                ...
                if (this.renderTpl != null)
                {
                    this.renderTpl.EnableViewState = this.DesignMode;
        ...
        /// 
        /// </summary>
        public virtual bool RenderXType
        {
            get
            {
        ...
        ///<summary>
        /// Updates this component's layout. If this update effects this components ownerCt, that component's updateLayout method will be called to perform the layout instead. Otherwise, just this component (and its child items) will layout.
        ///</summary>
        [Meta]
        public virtual void UpdateLayout()
        {
            this.Call("updateLayout");
        }
        ...
        public virtual string ContentEl
        {
            get
            {
                ...
                return this.IsProxy ? this.ConfigID + "_Content" : this.ContentContainer.ClientID;
            }
        }
        ...
        [NotifyParentProperty(true)]
        [Description("")]
        public virtual ITemplate HtmlBin
        {
            get
            {
                return this.htmlBin;
        ...
        [DefaultValue(false)]
        [NotifyParentProperty(true)]
        [Description("A flag which causes the AbstractComponent to attempt to restore the state of internal properties from a saved state on startup. Defaults to false.")]
        public virtual bool Stateful
        {
            get
            {
                return this.State.Get<bool>("Stateful", false);
            }
            set
            {
        ...
        protected void SetBorder(bool? border)
        {
            if (border.HasValue)
            {
                this.Call("setBorder", border.Value);
            }
        }
        ...
        /// </summary>
        /// <param name="border"></param>
        protected void SetBorderSpec(string border)
        {
            if (border.IsEmpty())
            {
                this.Call("setBorder", false);
            }
            else
            {
                this.Call("setBorder", border);
            }
        }
        ...
        {
            this.Render(id, RenderMode.Replace);
        }
        ...
        public void Replace(AbstractComponent cmp)
        {
            this.Replace(cmp.ClientID);
        }

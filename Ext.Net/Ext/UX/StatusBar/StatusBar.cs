...
namespace Ext.Net
{
    ...
    public partial class StatusBar : ToolbarBase
    {
        ...
        public virtual string GetIconClass(Icon icon)
        {
            if (icon != Icon.None)
            {
                return string.Format(".{0}{{background-image:url({1}) !important;padding-left: 25px !important;background-repeat: no-repeat;background-position: 3px 0px;}}", ResourceManager.GetIconRequester(icon), this.ResourceManager.GetIconUrl(icon));
            }
            return "";
        }
        ...
        public override string InstanceOf
        {
            get
            {
                return "Ext.ux.statusbar.StatusBar";
            }
        }
        ...
        public virtual int AutoClear
        {
            get
            {
                return this.State.Get<int>("AutoClear", 5000);
            }
            set
            {
                this.State.Set("AutoClear", value);
            }
        }
        ...
        protected virtual string BusyIconClsProxy
        {
            get
            {
                ...
                {
                    return ResourceManager.GetIconRequester(this.BusyIcon);
                }
        ...
        public virtual string BusyIconCls
        {
            get
            {
                return this.State.Get<string>("BusyIconCls", "x-status-busy");
            }
            set
            {
        ...
        public virtual string BusyText
        {
            get
            {
                return this.State.Get<string>("BusyText", "Loading...");
            }
            set
            {
                this.State.Set("BusyText", value);
            }
        }
        ...
        public override string Cls
        {
            get
            {
                return this.State.Get<string>("Cls", "x-statusbar");
            }
            set
            {
        ...
        public virtual Icon DefaultIcon
        {
            get
            {
                return this.State.Get<Icon>("DefaultIcon", Icon.None);
            }
            set
            {
                this.State.Set("DefaultIcon", value);
            }
        }
        ...
        protected virtual string DefaultIconClsProxy
        {
            get
            {
                ...
                {
                    return ResourceManager.GetIconRequester(this.DefaultIcon);
                }
        ...
        public virtual string DefaultIconCls
        {
            get
            {
                return this.State.Get<string>("DefaultIconCls", "");
            }
            set
            {
                this.State.Set("DefaultIconCls", value);
            }
        }
        ...
        public virtual string DefaultText
        {
            get
            {
                return this.State.Get<string>("DefaultText", "&nbsp;");
            }
            set
            {
        ...
        public virtual StatusAlign StatusAlign
        {
            get
            {
                return this.State.Get<StatusAlign>("StatusAlign", StatusAlign.Left);
            }
            set
            {
                this.State.Set("StatusAlign", value);
            }
        }
        ...
        public StatusBarDirectEvents DirectEvents
        {
            get
            {
                ...
                {
                    this.directEvents = new StatusBarDirectEvents(this);
                }
        ...
        {
            this.SetIconClass(ResourceManager.GetIconRequester(icon));
        }
    ...
    public partial class StatusBarStatusConfig : BaseControl
    {
        /// <summary>
        /// 
        /// </summary>
    ...
    [ToolboxItem(false)]
    [Description("A config object containing any or all of the following properties. If this object is not specified the status will be cleared using the defaults.")]
    public partial class StatusBarClearStatusConfig : BaseControl
    {
        /// <summary>
        /// 
        /// </summary>

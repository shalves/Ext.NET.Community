...
namespace Ext.Net
{
    ...
    {        
        ...
        /// </summary>
        /// <param name="className">The CSS class to add on click</param>
        /// <param name="testFn">A test function to execute before adding the class. The passed parameter will be the Element instance. If this functions returns false, the class will not be added.</param>
        /// <returns>This element</returns>
        [Description("Sets up event handlers to add and remove a css class when the mouse is down and then up on this element (a click effect)")]
        public virtual Element AddClsOnClick(string className, JFunction testFn)
        {
            this.Call("addClsOnClick", className, JRawValue.From(testFn.ToScript()));
            return this;
        }
        ...
        /// <param name="className">The CSS class to add on click</param>
        /// <param name="testFn">A test function to execute before adding the class. The passed parameter will be the Element instance. If this functions returns false, the class will not be added.</param>
        /// <param name="scope">The scope to execute the testFn in.</param>
        /// <returns>This element</returns>
        [Description("Sets up event handlers to add and remove a css class when the mouse is down and then up on this element (a click effect)")]
        public virtual Element AddClsOnClick(string className, JFunction testFn, string scope)
        {
            this.Call("addClsOnClick", className, JRawValue.From(testFn.ToScript()), JRawValue.From(scope));
            return this;
        }
        ...
        /// <returns>This element</returns>
        [Description("Sets up event handlers to add and remove a css class when this element has the focus")]
        public virtual Element AddClsOnFocus(string className, JFunction testFn, string scope)
        {
            this.Call("addClsOnFocus", className, JRawValue.From(testFn.ToScript()), JRawValue.From(scope));
            return this;
        }
        ...
        /// <returns>This element</returns>
        [Description("Sets up event handlers to add and remove a css class when the mouse is over this element")]
        public virtual Element AddClsOnOver(string className, JFunction testFn)
        {
            this.Call("addClsOnOver", className, JRawValue.From(testFn.ToScript()));
            return this;
        }
        ...
        public virtual Element Animate(AnimConfig args)
        {
            this.Call("animate", new JRawValue(new ClientConfig().Serialize(args)));
            return this;
        }

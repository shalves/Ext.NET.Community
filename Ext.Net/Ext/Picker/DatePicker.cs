...
namespace Ext.Net
{
    ...
    public partial class DatePicker : ComponentBase, IDate, IAutoPostBack, IXPostBackDataHandler, IPostBackEventHandler, INoneContentable
    {
        ...
        [Description("The text to display for the aria title. Defaults to: \"Date Picker: {0}\"")]
        public virtual string AriaTitle
        {
            get
            {
                return this.State.Get<string>("AriaTitle", "Date Picker: {0}");
            }
            set
            {
                this.State.Set("AriaTitle", value);
            }
        }
        ...
        [Localizable(true)]
        [Description("The date format to display for the current value in the ariaTitle. Defaults to: \"MMMM dd, yyyy\"")]
        public virtual string AriaTitleDateFormat
        {
            get
            {
                return this.State.Get<string>("AriaTitleDateFormat", "MMMM dd, yyyy");
            }
            set
            {
                this.State.Set("AriaTitleDateFormat", value);
            }
        }
        ...
        [DefaultValue("F d, Y")]
        [Description("")]
        protected string AriaTitleDateFormatProxy
        {
            get
            {
                CultureInfo ci = this.HasResourceManager ? this.ResourceManager.CurrentLocale : CultureInfo.InvariantCulture;
                return DateTimeUtils.ConvertNetToPHP(this.AriaTitleDateFormat, ci);
            }
        }
        ...
        public virtual string DisabledCellCls
        {
            get
            {
                return this.State.Get<string>("DisabledCellCls", "");
            }
            set
            {
        ...
        [Localizable(true)]
        [Description("The date format for the header month. Defaults to: \"MMMM yyyy\"")]
        public virtual string MonthYearFormat
        {
            get
            {
                return this.State.Get<string>("MonthYearFormat", "MMMM yyyy");
            }
            set
            {
                this.State.Set("MonthYearFormat", value);
            }
        }
        ...
        [DefaultValue("F Y")]
        [Description("")]
        protected string MonthYearFormatProxy
        {
            get
            {
                CultureInfo ci = this.HasResourceManager ? this.ResourceManager.CurrentLocale : CultureInfo.InvariantCulture;
                return DateTimeUtils.ConvertNetToPHP(this.MonthYearFormat, ci);
            }
        }

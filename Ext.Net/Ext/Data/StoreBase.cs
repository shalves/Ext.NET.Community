...
namespace Ext.Net
{
    ...
    public abstract partial class StoreBase : AbstractStore
    {
        ...
        /// <param name="options">See options for load</param>
        [Meta]
        public virtual void LoadPage(int page, object options)
        {
            this.Call("loadPage", page, options);
        }
        ...
        /// </summary>
        /// <param name="data">The full JSON object you'd like to load into the Data store.</param>
        /// <param name="append">True to add the records to the existing records in the store, false to remove the old ones first.</param>
        [Meta]
        public virtual void LoadRawData(object data, bool append)
        {
            this.Call("loadRawData", data, append);
        }
        ...
        /// <param name="data">The full JSON object you'd like to load into the Data store.</param>
        [Meta]
        public virtual void LoadRawData(object data)
        {
            this.Call("loadRawData", data);
        }
        ...
        /// <param name="options">See options for load</param>
        [Meta]
        public virtual void NextPage(object options)
        {
            this.Call("nextPage", options);
        }
        ...
        /// <param name="end"></param>
        [Meta]
        public virtual void PrefetchRange(int start, int end)
        {
            this.Call("prefetchRange", start, end);
        }
        ...
        public override void DataBind()
        {
            ...
            if (this.IsProxy || (RequestManager.IsAjaxRequest && !this.IsAjaxRequestInitiator && !this.IsDynamic))
            {
                this.AjaxDataBind();
                return;
            }

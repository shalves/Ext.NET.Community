...
namespace Ext.Net
{
    ...
    public abstract partial class TreePanelBase : PanelBase, INoneContentable
    {
        ...
        public void ReplaceChildNode(string nodeId, TreeNodeBase newNode, string oldChildNodeId)
        {
            this.CallNode("replaceChild", nodeId, new JRawValue(newNode.ToScript(false)), new JRawValue(this.ClientID.ConcatWith(".getNodeById(", JSON.Serialize(oldChildNodeId), ")")));
        }
